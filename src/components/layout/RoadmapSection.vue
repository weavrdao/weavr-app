...
export default {
  ...
  data() {
    return {
      images: {
        roadmap: require('../../assets/pics/roadmap.svg'),
        mesh2d: require('../../assets/pics/frabric-mesh-2d.png')
      }
    }
  },
  computed: {
    roadmapStyle() {
      return `
      backgroundImage: url('${this.images.mesh2d}');
...
.roadmap-bg {
  ...
  background-image: radial-gradient(at 50% 50%, rgba(0,0,0,1) 30%, rgba(0,0,0,0) 50%);
  mask-image: 
    /* linear-gradient(to bottom, rgba(0,0,0,0), rgba(0,0,0,0.8), rgba(0,0,0,0)), */
    radial-gradient(at 50% 50%, rgba(0,0,0,1) 30%, rgba(0,0,0,0) 50%);
}
</style>